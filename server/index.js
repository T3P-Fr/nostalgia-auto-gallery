...
/**
 * Vérifie la clé administrateur pour les opérations sensibles.
 * @param {import("express").Request} request Requête Express.
 * @param {import("express").Response} response Réponse Express.
 * @param {import("express").NextFunction} next Suite du traitement.
...
/**
 * Nettoie une chaîne reçue du client pour limiter les données inutiles.
 * @param {unknown} value Valeur à normaliser.
 * @param {number} maximumLength Longueur maximale conservée.
...
/**
 * Valide et normalise une demande de rendez-vous.
